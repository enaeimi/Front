...
const AddProjectForm = ({ editProject, onClose }) => {
  ...
  const [projectState, setProjectState] = useState(
    editProject ? editProject.status : ""
  );
  ...
  useEffect(() => {
    setProjectName(editProject ? editProject.name : "");
    setProjectState(editProject ? editProject.status : "");
  }, [editProject]);
